...
class InkySprite(Inky):
    """Inky with his sprite."""

    def __init__(self, pacman: PacMan, spritesheet: SpriteSheet) -> None:
        super().__init__(pacman)

        self.up = [spritesheet.image_at(4, 6, 14, 1.8), spritesheet.image_at(5, 6, 14, 1.8)]
        self.right = [spritesheet.image_at(0, 6, 14, 1.8), spritesheet.image_at(1, 6, 14, 1.8)]
        self.down = [spritesheet.image_at(6, 6, 14, 1.8), spritesheet.image_at(7, 6, 14, 1.8)]
        self.left = [spritesheet.image_at(2, 6, 14, 1.8), spritesheet.image_at(3, 6, 14, 1.8)]
