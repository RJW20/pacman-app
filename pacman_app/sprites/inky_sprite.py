...
class InkySprite(Inky):
    ...
    def __init__(self, pacman: PacMan, spritesheet: SpriteSheet) -> None:
        ...
        self.up = [spritesheet.image_at(4, 6, 14), spritesheet.image_at(5, 6, 14)]
        self.right = [spritesheet.image_at(0, 6, 14), spritesheet.image_at(1, 6, 14)]
        self.down = [spritesheet.image_at(6, 6, 14), spritesheet.image_at(7, 6, 14)]
        self.left = [spritesheet.image_at(2, 6, 14), spritesheet.image_at(3, 6, 14)]
