...
class PinkySprite(Pinky):
    ...
    def __init__(self, pacman: PacMan, spritesheet: SpriteSheet) -> None:
        ...
        self.up = [spritesheet.image_at(4, 5, 14), spritesheet.image_at(5, 5, 14)]
        self.right = [spritesheet.image_at(0, 5, 14), spritesheet.image_at(1, 5, 14)]
        self.down = [spritesheet.image_at(6, 5, 14), spritesheet.image_at(7, 5, 14)]
        self.left = [spritesheet.image_at(2, 5, 14), spritesheet.image_at(3, 5, 14)]
