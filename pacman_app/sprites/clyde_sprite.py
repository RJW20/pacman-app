...
from pacman_app import Clyde, PacMan
...
class ClydeSprite(Clyde):
    """Clyde with his sprite."""

    def __init__(self, pacman: PacMan, spritesheet: SpriteSheet) -> None:
        super().__init__(pacman)

        self.up = [spritesheet.image_at(4, 7, 14, 1.8), spritesheet.image_at(5, 7, 14, 1.8)]
        self.right = [spritesheet.image_at(0, 7, 14, 1.8), spritesheet.image_at(1, 7, 14, 1.8)]
        self.down = [spritesheet.image_at(6, 7, 14, 1.8), spritesheet.image_at(7, 7, 14, 1.8)]
        self.left = [spritesheet.image_at(2, 7, 14, 1.8), spritesheet.image_at(3, 7, 14, 1.8)]
